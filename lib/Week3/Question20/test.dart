...
void main() {
  ...
  test('This will say your BMI of weight 100, and height of 1.70', (){
    expect(calculateBMI(100, 1.70), equals('BMI = 34.61 (Obese)'));
    print(calculateBMI(100, 1.70));
  });
  test('This will say your BMI of weight 10, and height of 1.70', (){
    expect(calculateBMI(10, 1.70), equals('BMI = 3.47 (Underweight)'));
  ...
  test('This will say your BMI of weight 900, and height of 3.70', (){
    expect(calculateBMI(900, 3.70), equals('BMI = 27.78 (Overweight)'));
    print(calculateBMI(900, 3.70));
  });
}
